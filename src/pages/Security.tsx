...
const securityFeatures = [
  ...
  },
  {
    ...
    description: "Found a security issue? Contact us at rakeshgajre.work@gmail.com. We take all reports seriously and respond within 48 hours.",
  },
];
        ...
        <section className="py-20 px-4 text-center bg-gradient-to-b from-primary/10 to-background">
          <div className="max-w-3xl mx-auto space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
              <span className="text-primary">Security</span> at CertiVault
            </h1>
