    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1 py-20 px-4">
        <div className="max-w-3xl mx-auto prose prose-neutral dark:prose-invert">
          ...
          <p>By accessing or using CertiVault Credentials, you agree to be bound by these Terms of Service. If you do not agree, please do not use the platform.</p>
          ...
          <p>All platform content, design, and technology are owned by CertiVault Credentials. Users retain ownership of credential data they upload.</p>

          <h2>6. Limitation of Liability</h2>
          <p>CertiVault Credentials is provided "as is" without warranty. We are not liable for any damages arising from use of the platform.</p>
          ...
          <h2>8. Contact</h2>
          <p>For questions about these terms, contact us at <a href="mailto:rakeshgajre.work@gmail.com" className="text-primary">rakeshgajre.work@gmail.com</a>.</p>
        </div>
      </main>
      <Footer />
    </div>
